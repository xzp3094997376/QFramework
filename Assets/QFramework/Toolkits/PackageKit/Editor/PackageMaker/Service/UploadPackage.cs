 ...
 public static class UploadPackage
    {
        ...
        public static void DoUpload(PackageVersion packageVersion, System.Action succeed)
        {
            ...
            // foreach (var packageVersionIncludeFileOrFolder in packageVersion.IncludeFileOrFolders)
            // {
            //     form.AddField("includeFileOrFolders",packageVersionIncludeFileOrFolder);    
            // }
